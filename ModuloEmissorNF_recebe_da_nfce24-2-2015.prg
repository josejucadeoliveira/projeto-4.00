...
///////////verifica serviços
*NFe_SWS()
*retorno_servico:=SUBSTR(Ret_Status, 1, 4)
*msginfo(retorno_servico)
**
*if alltrim(retorno_servico)="ERRO"
...
MsgStop('Chave não Valida', "ATENÇÃO")
return (.f.)
endif 

if alltrim(retorno_envair)="ERRO"
 	  MsgStop("Houve um Erros ao Enviar a nota favor Reenviar      "+retornoenvair)
 return(.f.)
endif
