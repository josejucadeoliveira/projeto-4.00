...
DEFINE TAB Tab_Movimento AT 180,00;
 ...
 PAGE "Produtos" 
	...
	@ 20,05 GRID fita ;
        ...
        HEADERS {'Itens','Codigo','Descrição','Ncm','Und.','Qtd','Valor R$','Desc.R$','Sub-Total R$','%Icms','CST','CFOP','ICMS' };
        VALUE 1 ;			
...
IF nfe.oRad3.VALUE == 1
eQuery := oServer:Query( "Select CbdcProd ,CbdcEAN,CbdxProd,CbdnItem,CbdvProd,CbdNtfNumero,CbdNCM,CbdqCOM,CbdvUnCom,CbdUCom,CbdvDesc,cbdvoutro_item From nfeitem WHERE CbdNtfNumero ="+ntrim(xnum)+" Order By CbdxProd" )
endif
IF nfe.oRad3.VALUE == 2
