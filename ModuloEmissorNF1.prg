...
abreboleto()
Reconectar_A() 
oQuery        := oServer:Query( "Select MAX(num_seq)FROM NFCE num_seq")
...
xVALOR_TOT:=int(xVALOR_TOT*100)/100
 ...
 NFE.Txt_desconto.value     :=xdesc1      //XVALOR_DESC
...
if nfe.textBTN_cfop.value =5929 .and. nfe.oRad3.VALUE = 3 
