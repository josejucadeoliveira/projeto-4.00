...
@ 010, 05 LABEL oSay5 Value "Didigte Nº Cupom(COO)";
...
DEFINE WINDOW wbolseq  ; 
    ...
    @ 25,10 BROWSE boleto                       ;  
      WIDTH 540                                 ;
      HEIGHT 240                                ;   
      HEADERS { 'Número','Sacado','Vencimento','Valor R$' }      ; 
   ...
   @ 25,590 GRID selecao;
    WIDTH 440;
    HEIGHT 240   ; 
    HEADERS { 'Número','Vencimento','Valor' }    ; 
    WIDTHS { 80,160,120 };
    JUSTIFY { 1,1,1 } ;
	value 0
...
msgInfo(PADR('Registro não encontrado',50),tt)
RETURN
